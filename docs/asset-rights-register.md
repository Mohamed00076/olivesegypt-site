...
| `assets/olive-kalamata.jpg` | Kalamata Olives product photograph | Supplied by the site owner, 2026-09-05 | Owner-confirmed; supplied for use on this site | Triple Company for Industrial Development | No | `/catalog`, `/catalog/print`, `/downloads`, `/products/kalamata-olives` and the four Arabic equivalents; both B2B export catalogue PDFs | Revert to `illus-kalamata.svg` / `illus-kalamata-ar.svg`, which remain in the repo |
